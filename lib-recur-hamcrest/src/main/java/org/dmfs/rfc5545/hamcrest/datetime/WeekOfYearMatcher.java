...
/**
 * Matches the week of year of a {@link DateTime}.
 *
 * @author Marten Gajda
 */
public final class WeekOfYearMatcher extends FeatureMatcher<DateTime, Integer>
{
    ...
    {
        super(subMatcher, "week of year", "week of year");
    }
    ...
    public static Matcher<DateTime> inWeekOfYear(Integer... weekOfYear)
    {
        return new WeekOfYearMatcher(new AnyOf<>(new Mapped<>(Matchers::equalTo, new Seq<>(weekOfYear))));
    }
