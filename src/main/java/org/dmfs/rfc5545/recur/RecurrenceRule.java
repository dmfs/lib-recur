 ...
 * href="http://tools.ietf.org/html/rfc5545#section-3.3.10">RFC 5545</a>. <p> The goal of this implementation is to satisfy the following qualities: </p> <ul>
 ...
 * not explicitly mentioned.</li> <li>performance: The iterator shall be as efficient (in speed and memory utilization) as possible. </ul> <p> TODO: Add
...
public final class RecurrenceRule
{
    ...
    public enum Part
    {
        ...
        /**
         * Return a {@link RuleIterator} that is suitable to build a recurrence rule filter chain in order to iterate all instances. <p> <strong>Note:</strong>
     ...
     * which means every Sunday in the interval. <p> These values are defined as: </p>
     * <p>
     * <pre>
     ...
     * current {@link RfcMode}. Also, it doesn't require FREQ to be the first part (that's required in <a href="http://tools.ietf.org/html/rfc2445#section-4.3.10">RFC
     ...
     * {@link Part#BYYEARDAY}, {@link Part#BYWEEKNO}, {@link Part#BYMONTH}, or {@link Part#BYSETPOS}. <p> To set {@link Part#BYDAY} use {@link
     * #setByDayPart(List)}. </p>
     *
     * @param part
     *         The by-rule to set.
     ...
     * {@link #mode} is set to {@link RfcMode#RFC5545_STRICT} this method will throw an {@link UnsupportedOperationException}. <p> Note that calling this method
    ...
    /**
     * Returns a specific x-part. Since RFC 5545 doesn't support x-parts this method will always return <code>null</code> if {@link #mode} equals {@link
    ...
    /**
     * Get a new {@link RuleIterator} that iterates all instances of this rule. <p> <strong>Note:</strong> if an UNTIL part is present and it's value is a
    ...
    private static abstract class ValueConverter<T>
    {
        ...
        /**
         * Write the string representation of a value of type <T> to a {@link StringBuilder}. <p> The default implementation just calls {@link #toString()} on
         * the value. </p>
         *
         * @param out
