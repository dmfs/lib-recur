...
/**
 * A filter that limits recurrence rules by day of year. <p> <strong>Note: </strong> <a href="http://tools.ietf.org/html/rfc5545#section-3.3.10">RFC 5545</a>
...
final class ByYearDayFilter implements ByFilter
{
    ...
    public boolean filter(long instance)
    {
        ...
        return StaticUtils.linearSearch(mYearDays, dayOfYear) < 0 && StaticUtils.linearSearch(mYearDays,
                dayOfYear - yearDays) < 0 || dayOfYear > yearDays;
    }
}
