...
public final class RecurrenceRuleIterator implements InstanceIterator
{
     ...
     * called this. <p> <p> <strong>Note:</strong> At present this will loop infinitely when called on an infinite rule. So better check {@link
     * RecurrenceRule#isInfinite()} first. </p>
     */
